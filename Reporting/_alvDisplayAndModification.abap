...
* Display the main (large text) header - name of report
      lr_grid->create_header_information(
       row = 1
       column = 1
       text = 'Source List - BDC log output'(t01)
       tooltip = 'Source List - BDC log output'(t01) ).

* in the cell [2,1] of main grid, create sub-grid
      lr_grid_1 = lr_grid->create_grid( row = 2
                                        column = 1 ).

* create date/time string to display in first row
      CONCATENATE sy-datlo sy-timlo into l_text.

* display date/time in first row
      lr_text = lr_grid_1->create_text( row = 1
                                        ...
                                        tooltip = l_text ).
      Clear l_text.
* display user name in second row
...
* display additional data in other rows here


* set the top of list to our grid object
